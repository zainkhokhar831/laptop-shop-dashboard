                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <?php if ( $comment->comment_approved == '0') : ?>
                                <p><?php _e( 'Your comment is awaiting moderation', 'nestlaptops'); ?></p>
                            <?php endif?>
    ...
    <div class="col-md-12">
        <div class="widget">
            ...
            <div class="commentform">
                <form name="commentform" id="commentform" method="POST" action="<?php echo site_url( 'wp-comments-post.php' ) ?>" class="row">
